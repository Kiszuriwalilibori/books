import { FiltrationObject, BookRecordsArray } from "types";
 ...
 */
export const filtrate = (data: BookRecordsArray, filtr: FiltrationObject) => {
  let filtrationResult: BookRecordsArray = [];
