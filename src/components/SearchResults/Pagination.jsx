...
export const Pagination = connect(mapStateToProps, mapDispatchToProps)(withStyles({
    root: {
      margin: '40px auto',
      '& button':{background: 'rgba(122, 194, 33, 0.8)', color:'white',border:'1px solid #298B01',
      boxShadow: 'inset 0 0 5px #298B01', },
      '& button.Mui-selected':{background: '#F5C200', color:'black',border:'1px solid #EE760A',
